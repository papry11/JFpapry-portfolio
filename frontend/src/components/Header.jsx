...
import { portfolioAssets as assets } from "../assets/assets";
  ...
  return (
    <header className="flex flex-col items-center justify-center px-6 sm:px-10 md:px-16 lg:px-20 py-16 mt-20 md:mt-28 rounded-3xl text-center bg-primary-dull/40 shadow-inner border border-gray-200 relative overflow-hidden">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="space-y-3 z-10 max-w-2xl relative"
      >
        <motion.h1
          variants={fadeUp}
          className="text-2xl sm:text-4xl md:text-4xl font-bold leading-tight text-gray-800"
        >
        ...
        <motion.div variants={fadeUp} className="relative">
          <motion.h2
            variants={smallFade}
            className="text-3xl sm:text-4xl md:text-5xl font-semibold text-gray-800 relative z-10"
          >
            Full Stack Web Developer
          </motion.h2>

          {/* 👇 gradient background image added below the title */}
          <motion.img
            variants={smallFade}
            src={assets.gradientBackground}
            alt=""
            className="mx-auto mt-4 w-72 sm:w-96 md:w-[500px] opacity-60 select-none pointer-events-none"
          />
        </motion.div>
        ...
        >
          <motion.button
            ...
            className="w-40 sm:w-44 py-2.5 rounded-full bg-gray-800 text-white font-medium border border-gray-400 transition-all text-center"
          >
            See Projects
          </motion.button>
          ...
          <motion.button
            ...
            className="w-40 sm:w-44 py-2.5 rounded-full text-gray-800 font-medium border border-gray-400 transition-all text-center"
          >
            Contact
          </motion.button>
        </motion.div>
